 ...
 foreach ($appName in @("Chrome", "Edge", "Word", "Excel", "PowerPoint", "Outlook", "Teams")) {
    ...
    if ($exePath) {
        ...
        if ($appInfo.InstallFunction) {
            $currentApp = $appName
            Write-Host "$currentApp is not installed." -ForegroundColor Yellow
            Write-Host "Would you like to install $currentApp? (Y/N)" -ForegroundColor Cyan
            $installChoice = Read-Host
            ...
            if ($installChoice.ToUpper() -eq 'Y') {
                ...
                Write-Host "Skipping $currentApp installation" -ForegroundColor Yellow
            }
        }
        else {
