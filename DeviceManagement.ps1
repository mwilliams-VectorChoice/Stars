...
# Initialize the warning color at the script level
$script:warningColor = 'Red'

# Rest of the existing script remains the same until the Show-MainMenu function
function Show-MainMenu {
    ...
    Write-Host "IMPORTANT: Press 'Q' when finished to properly exit and cleanup downloaded update files" -ForegroundColor $script:warningColor
    Write-Host "If you exit any other way, temporary files will remain on your system" -ForegroundColor $script:warningColor
}
