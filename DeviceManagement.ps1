    ...
    try {
        ...
        for ($i = 0; $i -lt $retryCount; $i++) {
            try {
                ...
                Invoke-WebRequest -Uri $latestArchiveUrl -OutFile $localArchivePath -UseBasicParsing
        ...
        Write-Warning "Failed to download and extract the latest version of the script after $retryCount attempts."
    } catch {
