...
function Show-MainMenu {
    ...
    Write-Host "`n--- DEBUG: Current Warning Color Index: $script:warningColorIndex" -ForegroundColor Green
    Write-Host "--- DEBUG: Current Warning Color: $($script:warningColors[$script:warningColorIndex])" -ForegroundColor Green
