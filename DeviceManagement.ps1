...
function Install-PrinterDrivers {
    ...
    # Function to handle manual download fallback
    function Show-ManualDownloadInstructions {
        ...
        Write-Host "`nAutomatic download failed. Please follow these steps for manual download:" -ForegroundColor Yellow
    ...
    # Main printer setup logic
    switch ($Client) {
        "TMT" {
            $printerInfo = @{
                Name = "Canon ImageRunner Advance C5535i"
                ManualUrl = "https://www.usa.canon.com/support/p/imagerunner-advance-c5535i"
                Instructions = "Select 'Drivers & Downloads', choose your operating system, and download the PCL6 driver."
            }
            
            Write-Host "Setting up $($printerInfo.Name) printer for TMT..." -ForegroundColor Yellow
            Show-ManualDownloadInstructions -ManufacturerUrl $printerInfo.ManualUrl -ModelName $printerInfo.Name -Instructions $printerInfo.Instructions
        }
        
        "Dogwood" {
            $printerInfo = @{
                Name = "Kyocera TASKalfa 5054ci"
                ManualUrl = "https://www.kyoceradocumentsolutions.com.au/supportcentre/Pages/downloads.aspx?model=TASKalfa+5054ci"
                Instructions = "Select the driver package for your Windows version and download the PCL or PostScript driver."
            }
            
            Write-Host "Setting up $($printerInfo.Name) printer for Dogwood..." -ForegroundColor Yellow
            Show-ManualDownloadInstructions -ManufacturerUrl $printerInfo.ManualUrl -ModelName $printerInfo.Name -Instructions $printerInfo.Instructions
        }
        
        "ICM" {
            $printerInfo = @{
                Name = "Kyocera Document Solutions Printer"
                ManualUrl = "https://www.kyoceradocumentsolutions.us/en/support/downloads.html"
                Instructions = "Enter your printer model in the search box, select your model, and download the appropriate driver."
            }
            
            Write-Host "Setting up $($printerInfo.Name) printer for ICM..." -ForegroundColor Yellow
            Show-ManualDownloadInstructions -ManufacturerUrl $printerInfo.ManualUrl -ModelName $printerInfo.Name -Instructions $printerInfo.Instructions
        }
        ...
        "QuestGroup" {
            $printerInfo = @{
                Name = "Sharp BP-70C45"
                ManualUrl = "https://www.sharp.co.uk/cps/rde/xchg/gb/hs.xsl/-/html/download-centre.htm"
                Instructions = "Search for BP-70C45, select your Windows version, and download the recommended driver package."
            }
            
            Write-Host "Setting up $($printerInfo.Name) printer for QuestGroup..." -ForegroundColor Yellow
            Show-ManualDownloadInstructions -ManufacturerUrl $printerInfo.ManualUrl -ModelName $printerInfo.Name -Instructions $printerInfo.Instructions
        }
        ...
        "Maxwell" {
            $printerInfo = @{
                ...
                ManualUrl = "https://cscsupportftp.mykonicaminolta.com/DownloadFile/Download.ashx?fileversionid=33250&productid=2175"
                Instructions = "Download and run the driver package for Windows. Follow the installation wizard to complete setup."
            }
            
            Write-Host "Setting up $($printerInfo.Name) printer for Maxwell..." -ForegroundColor Yellow
            Show-ManualDownloadInstructions -ManufacturerUrl $printerInfo.ManualUrl -ModelName $printerInfo.Name -Instructions $printerInfo.Instructions
        }
        ...
        "S&S" {
            $printerInfo = @{
                ...
                ManualUrl = "https://www.support.xerox.com/en-us/product/altalink-c8000-series/downloads"
                Instructions = "Select your operating system, then download the PCL6 or PostScript driver package."
            }
            
            Write-Host "Setting up $($printerInfo.Name) printer for S&S..." -ForegroundColor Yellow
            Show-ManualDownloadInstructions -ManufacturerUrl $printerInfo.ManualUrl -ModelName $printerInfo.Name -Instructions $printerInfo.Instructions
        }
    ...
    Write-Host "`nOnce you have downloaded the driver package:" -ForegroundColor Yellow
    Write-Host "1. Run the installer from your downloads folder" -ForegroundColor Cyan
    Write-Host "2. Follow the manufacturer's installation instructions" -ForegroundColor Cyan
    Write-Host "3. For network printers, make sure you have the printer's IP address ready" -ForegroundColor Cyan
...
function Show-PrinterMenu {
    ...
    Write-Host "5. Maxwell (Konica Minolta bizhub C250i)" -ForegroundColor Cyan
    Write-Host "6. S&S (Xerox AltaLink C8030 MFP)" -ForegroundColor Cyan
...
function Handle-PrinterSetup {
    do {
        ...
        switch ($printerChoice) {
            "1" { Install-PrinterDrivers -Client "TMT" }
            "2" { Install-PrinterDrivers -Client "Dogwood" }
            "3" { Install-PrinterDrivers -Client "ICM" }
            "4" { Install-PrinterDrivers -Client "QuestGroup" }
            "5" { Install-PrinterDrivers -Client "Maxwell" }
            "6" { Install-PrinterDrivers -Client "S&S" }
            "Q" { return }
            default {
                Write-Host "Invalid choice. Please select a valid option." -ForegroundColor Red
