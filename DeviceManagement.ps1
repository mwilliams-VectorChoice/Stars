...
function Show-MainMenu {
    ...
    # Position cursor for flashing message
    $originalTop = [Console]::CursorTop
    
    # Flash the warning message in place
    for ($i = 0; $i -lt 3; $i++) {
        ...
        [Console]::SetCursorPosition(0, $originalTop)
        Write-Host "IMPORTANT: Press 'Q' when finished to properly exit and cleanup downloaded update files" -ForegroundColor Yellow
        Write-Host "If you exit any other way, temporary files will remain on your system" -ForegroundColor Yellow
        Start-Sleep -Milliseconds 500
    }
}
...
do {
    ...
    Show-HeaderArt  # Show the art first
