...
function Show-MainMenu {
    ...
    Write-Host "IMPORTANT: YOU MUST CHOOSE Q TO QUIT. CLOSING OUT WITHOUT Q WILL NOT REMOVE FILES DOWNLOADED FOR THE UPDATE" -ForegroundColor RED
}

# Display the menu FIRST
Show-MainMenu

# Start Flashing Warning in Background Job (AFTER menu appears)
