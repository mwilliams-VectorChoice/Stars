...
if ($global:CurrentScriptVersion -ne $scriptVersion) {
    ...
    try {
        ...
        for ($i = 0; $i -lt $retryCount; $i++) {
            try {
                Write-Host "Attempting to download the latest version of the script (attempt $($i + 1) of $retryCount)..."
                Invoke-WebRequest -Uri $latestScriptUrl -OutFile $localScriptPath -UseBasicParsing
                Write-Host "Downloaded the latest version of the script successfully."
                ...
                if (Test-Path $localScriptPath) {
                    ...
                    Write-Error "Failed to find the downloaded script at $localScriptPath"
                }
            } catch {
        ...
        Write-Warning "Failed to download and run the latest version of the script after $retryCount attempts."
    } catch {
