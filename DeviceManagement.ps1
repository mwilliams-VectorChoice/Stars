...
function Show-MainMenu {
    ...
    Write-Host "If you exit any other way, temporary files will remain on your system" -ForegroundColor Red
}
...
# Display flashing warning message
$i = 0
while ($i -lt 3) {  # Flash 3 times
    Write-Host "`r" -NoNewline
    Write-Host "IMPORTANT: Press 'Q' when finished to properly exit and cleanup downloaded update files`nIf you exit any other way, temporary files will remain on your system" -ForegroundColor Red -NoNewline
    Start-Sleep -Milliseconds 500
    Write-Host "`r" -NoNewline
    Write-Host "IMPORTANT: Press 'Q' when finished to properly exit and cleanup downloaded update files`nIf you exit any other way, temporary files will remain on your system" -ForegroundColor Yellow -NoNewline
    Start-Sleep -Milliseconds 500
    $i++
}
Write-Host "" # Add a blank line after flashing
